...
<!-- venkat hidden
                    <form class="search-top-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <span class="search-top-form-button"></span>
                        <span class="search-form-location">
                            <span class="search-form-arrow"></span>
                            <input id="s" value="" type="text" name="s" class="search-form-line" placeholder="<?php _ex('Search ...','search form','displaywp'); ?>" />
                        </span>
