...
<div class="row our-works content_top">
                ...
                <div class="col-md-3 flag_grid wow slideInLeft" style="visibility: visible; animation-name: slideInLeft;">
                 ...
                 <div class="work-member-cover">
                      ...
                      <img src="http://jetrelocations.com/demo/wp-content/themes/display/images/officeshifting.jpg" alt="team member">
                ...
                <div class="col-md-3 flag_grid wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                 ...
                 <div class="work-member-cover">
                    ...
                    <img src="http://jetrelocations.com/demo/wp-content/themes/display/images/homeshifting.jpg" alt="team member">
                ...
                <div class="work-member-cover">
                 ...
                 <img src="http://jetrelocations.com/demo/wp-content/themes/display/images/storagewarehousing.jpg" alt="team member">
                ...
                <div class="col-md-3 wow slideInRight" style="visibility: visible; animation-name: slideInRight;">
                 ...
                 <div class="work-member-cover">
                  <img src="http://localhost/jetrelocations/wp-content/themes/display/images/cartran.jpg" alt="team member">       
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12" style="padding-top:15px">
                           ...
                           <figure class="clearfix">
                               ...
                               <div class="col-md-2 col-sm-2 col-xs-12"><img class="img-responsive media-object" src="http://jetrelocations.com/demo/wp-content/themes/display/images/ajay.JPG"> </div>

                               <div class="col-md-10 col-sm-10 col-xs-12">

                                    <figcaption class="caption">

                                        <p class="text-brand lead no-margin">Software Engineer, Bangalore</p>

                                        <p><span class="glyphicon glyphicon-thumbs-up"></span> "Honest.Fast.Safe. I chose Jet relocations to shift from Koramangala To Bellandur and it was a pleasurable experience. I did not touch a thing! My entire house was inside carton boxes within no time and was relocated to my new house in a very safe manner. Brilliant job!" </p>

                                        <blockquote class="no-margin">

                                            <p>Software Engineer, Bangalore</p> <small><cite title="Source Title"><i class="glyphicon glyphicon-globe"></i> <!--www.example1.com --></cite></small> </blockquote>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12" style="padding-top:15px">
                           ...
                           <figure class="clearfix">
                               ...
                               <div class="col-md-2 col-sm-2 col-xs-12"><img class="img-responsive media-object" src="http://jetrelocations.com/demo/wp-content/themes/display/images/avt.jpg"> </div>

                               <div class="col-md-10 col-sm-10 col-xs-12">

                                    <figcaption class="caption">

                                        <p class="text-brand lead no-margin">Mr. Ramanujam, Samsung, Bangalore</p>
                                        ...
                                        <blockquote class="no-margin">
                                            ...
                                            <p>Mr. Ramanujam</p> <small><cite title="Source Title"><i class="glyphicon glyphicon-globe"></i> <!--www.example1.com --></cite></small> </blockquote>
