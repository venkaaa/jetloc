...
{
    setTimeout(function(){
      if(jQuery('ul#slide-wrapper li:first').hasClass('active'))
    {
       
        jQuery('ul#slide-wrapper li').filter('.active').removeClass('active');
        jQuery('ul#slide-wrapper li:last-child').addClass('active');
         jQuery('ul#slide-wrapper li.active').fadeIn("slow").css({'opacity': '0.969906', 'position':'relative', 'z-index':'1'});

        var getin = jQuery('ul#slide-wrapper li.active').index()+1;
        jQuery('ul.the-bullets li').removeClass('active');
        jQuery('ul.the-bullets li:nth-child('+getin+')').addClass('active');

        jQuery('ul#slide-wrapper li.active').prevAll().fadeOut("slow").css({'position':'absolute', 'top':'0px', 'left':'0', 'right':' 0px', 'z-index':'0', 'display':'none'});
        jQuery('ul#slide-wrapper li.active').nextAll().fadeOut("slow").css({'position':'absolute', 'top':'0px', 'left':'0', 'right':' 0px', 'z-index':'0', 'display':'none'});
    ...
    else
    {
        ...
        jQuery('ul#slide-wrapper li').filter('.active').removeClass('active').prev().addClass('active');
        var getin = jQuery('ul#slide-wrapper li.active').index()+1;
        jQuery('ul.the-bullets li').removeClass('active');
        jQuery('ul.the-bullets li:nth-child('+getin+')').addClass('active');
 ...
 setTimeout(function(){
      if(!jQuery('ul#slide-wrapper li').hasClass('active'))
    {
        console.log('dd');
        jQuery('ul#slide-wrapper li:first-child').addClass('active');
    }
     }, 500);
}
...
jQuery(document).ready(function(){
    ...
    if(jQuery('ul#slide-wrapper li:first').hasClass('active'))
    {
        ...
        jQuery('ul#slide-wrapper li:last-child').addClass('active');
         ...
         jQuery('ul#slide-wrapper li.active').fadeIn().css({'opacity': '0.969906', 'position':'relative', 'z-index':'1'});
...
jQuery('.slide-right').click(function(){
    ...
    if(jQuery('ul#slide-wrapper li:last').hasClass('active'))
    {
    ...
    else
    {
        ...
        jQuery('ul#slide-wrapper li').filter('.active').removeClass('active').next().addClass('active');
          jQuery('ul#slide-wrapper li.active').fadeIn().css({'opacity': '0.969906', 'position':'relative', 'z-index':'1'});
        var getin = jQuery('ul#slide-wrapper li.active').index()+1;
        jQuery('ul.the-bullets li').filter('.active').removeClass('active');
        jQuery('ul.the-bullets li').removeClass('active');
        jQuery('ul.the-bullets li:nth-child('+getin+')').addClass('active');
...
if(!jQuery('ul#slide-wrapper li').hasClass('active'))
    {
      ...
      jQuery('ul#slide-wrapper li:first-child').addClass('active');
       jQuery('ul#slide-wrapper li.active').fadeIn().css({'opacity': '0.969906', 'position':'relative', 'z-index':'1'});
        ...
        jQuery('ul.the-bullets li:nth-child('+getin+')').addClass('active');
        console.log(getin);
        jQuery('ul#slide-wrapper li.active').prevAll().fadeOut("slow");
        jQuery('ul#slide-wrapper li.active').nextAll().fadeOut("slow");
...
<div class="bg-lf-shadow"></div>
        ...
        <div class="homecirclereadmore">
         <div class="row ">
            ...
            <p>Jet Relocations is a devoted Packer and Mover company designed in a way that suits you. We believe Packing and moving is not just a Service it is about Well-being!  Starting with goodwill between two sides we at Jet Relocations aim to tend you as a family member by interacting and understanding your need to provide the best Packing and Moving service to each one of you and make your relocation a tension free Job.  </p>

<p>We are very conscious that customer satisfaction is of the utmost importance in Packing and Moving industry. From the beginning of your move to its completion, you will receive the best and friendly service that express all aspects of your move, from pre-move planning part to the unpacking and removal of your moving objects. We as your Jet Relocation Packing and Moving company service will be there with you every pace of your way.</p>
<p>We believe in the concept of Continuous Training to our employee to achieve efficiency in our work. Jet Relocations provides you the quality relocation service with pre-set plans, personal touch, risk management & exact communication from time to time. All our aspects of Packing and Moving Services are tailored towards commercial and residential clients that fits to your needs. We mainly focus on our strengths to provide the quality in all you want which include Household shifting, Office shifting, Car transportation, Packing Moving service and all. </p>
<p>Jet relocation is a full service packing and moving company, Our business activities includes Household Goods Shifting, Office Shifting/ Corporate Shifting, Car Transportation, Bike Transportation, Loading and Unloading, Warehousing and Storage, Door to Door Delivery, Electronic Items Shifting, Machinery Shifting and many more. Our friendly, trustworthy and experienced staff are available all the 7 days of week to provide you the want you need.
</p>
<br />

<p>
If you have any questions or would like to speak to us about an upcoming move then please don’t hesitate to <a href="<?php echo get_permalink() ?>contacts/" style="font-weight:bold; text-decoration:none; color:#fff;">contact us</a>.
</p>
...
<div class="row our-works content_top">
                ...
                <div class="col-md-3 flag_grid wow slideInLeft" style="visibility: visible; animation-name: slideInLeft;">
                 ...
                 <div class="flag_desc">
                    ...
                    <p>There is something really exciting us about an office shifting because we’re aware how much organising and planning is needed for an office move to go well</p>
                ...
                <div class="col-md-3 flag_grid wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                 ...
                 <div class="flag_desc">
                    ...
                    <p>Everything they say about House hold shifting is stressful, a time consuming, it takes lot of effort and also might call it quite a headache! But we are here to prove that</p>
                ...
                <div class="work-member-cover">
                 ...
                 <div class="flag_desc">
                    ...
                    <p>Whether you are seeking a warehousing service for residential purpose or commercial, warehousing and storage to handle overflow inventory, </p>
                ...
                <div class="col-md-3 wow slideInRight" style="visibility: visible; animation-name: slideInRight;">
                 ...
                 <div class="flag_desc">
                    ...
                    <p>When it comes to Moving cars and other vehicles, you could see it hard to imagine the total transport action, But don’t worry. We are here to make it easy to you!</p>
        ...
        <div class="row">
            ...
            <div class="col-md-8 bcrow" style="padding-right: 0px;
margin: 0px;">
