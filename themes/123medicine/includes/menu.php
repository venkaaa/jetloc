...
$disable_logo_sticky = ot_get_option('disable_logo_sticky');
...
<div class="header-menu">
	<nav class="navbar" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse <?php if ($dropdown_font_style=="bold") { ?>dd-bold-font<?php } ?> <?php if ($navigation_font_style=="bold") { ?>bold-font<?php } ?> animation-dd">
			<?php if (!$disable_logo_sticky) { ?><?php if ($custom_logo) { ?><div class="menu-logo"><img alt="<?php bloginfo( 'name' ); ?>" src="<?php echo $custom_logo?>"/></div><?php } ?><?php } ?>
