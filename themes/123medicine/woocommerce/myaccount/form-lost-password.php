...
<form action="<?php echo esc_url( get_permalink($post->ID) ); ?>" method="post" class="lost_reset_password">
    ...
    <p class="form-row"><input type="submit" class="btn btn-primary" name="reset" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', GETTEXT_DOMAIN ) : __( 'Save', GETTEXT_DOMAIN ); ?>" /></p>
