...
<?php endif; ?>
		...
		<h2 class="my-account-title"><?php _e( 'Login', GETTEXT_DOMAIN ); ?></h2>
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				?>"><?php _e( 'Lost Password?', GETTEXT_DOMAIN ); ?></a>
			</p>
		</form>
...
<?php if (get_option('woocommerce_enable_myaccount_registration')=='yes') : ?>
	...
	<div class="col-2">
		...
		<h2 class="my-account-title"><?php _e( 'Register', GETTEXT_DOMAIN ); ?></h2>
