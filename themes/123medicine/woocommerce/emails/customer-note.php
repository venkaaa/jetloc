...
<p><?php _e("Hello, a note has just been added to your order:", GETTEXT_DOMAIN); ?></p>

<blockquote><?php echo wpautop(wptexturize( $customer_note )) ?></blockquote>

<p><?php _e("For your reference, your order details are shown below.", GETTEXT_DOMAIN); ?></p>
