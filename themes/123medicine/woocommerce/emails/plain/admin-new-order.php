...
echo sprintf( __( 'You have received an order from %s. Their order is as follows:', GETTEXT_DOMAIN ), $order->billing_first_name . ' ' . $order->billing_last_name ) . "\n\n";
...
echo sprintf( __( 'Order date: %s', GETTEXT_DOMAIN), date_i18n( __( 'jS F Y', GETTEXT_DOMAIN ), strtotime( $order->order_date ) ) ) . "\n";
...
echo __( 'Customer details', GETTEXT_DOMAIN ) . "\n";
