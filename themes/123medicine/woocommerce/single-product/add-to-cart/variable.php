	...
	<div class="single_variation_wrap" style="display:none;">
		...
		<div class="variations_button">
			<div class="variations_button_wrap clearfix">
				...
				<button type="submit" class="single_add_to_cart_button btn btn-primary"><span class="halflings shopping-cart halflings-icon white"></span><?php echo apply_filters('single_add_to_cart_text', __( 'Add to cart', 'woocommerce' ), $product->product_type); ?></button>
			</div>
		</div>
	</div>
	<div>
