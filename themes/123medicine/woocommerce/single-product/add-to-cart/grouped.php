...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="cart" method="post" enctype='multipart/form-data'>
					...
					<tr>
						<td>
							<?php if ( $child_product['product']->is_type('external') ) : ?>
								...
								<a href="<?php echo esc_url( $child_product['product']->get_product_url() ); ?>" rel="nofollow" class="btn btn-primary btn-sm"><?php echo apply_filters('single_add_to_cart_text', esc_html( $child_product['product']->get_button_text() ), 'external'); ?></a>
	
							<?php elseif ( ! $quantites_required ) : ?>
	
								<a href="<?php echo esc_url( $child_product['product']->add_to_cart_url() ); ?>" rel="nofollow" class="single_add_to_cart_button btn btn-primary btn-sm"><?php echo apply_filters( 'single_add_to_cart_text', __( 'Add to cart', GETTEXT_DOMAIN ), $child_product['product']->product_type ); ?></a>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<div class="wrap-group-button clearfix"><button type="submit" class="single_add_to_cart_button btn btn-primary"><span class="halflings shopping-cart halflings-icon white"></span><?php echo apply_filters('single_add_to_cart_text', __( 'Add to cart', GETTEXT_DOMAIN ), $product->product_type); ?></button></div>
