...
global $post, $product;
?>
<?php if ( $product->is_type( array( 'simple', 'variable' ) ) && get_option( 'woocommerce_enable_sku' ) == 'yes' && $product->get_sku()||get_the_terms( $post->ID, 'product_cat' )||get_the_terms( $post->ID, 'product_tag' ) ) : ?>
