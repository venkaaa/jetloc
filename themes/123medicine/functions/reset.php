...
function lpd_register_menu() {
	...
	register_nav_menu('left-hm-menu', __('Left Header Menu', GETTEXT_DOMAIN));
...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'portfolio-page', 870, 870, true ); // portfolio image
