...
function vc_featured_module_1_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   $image_cropped = wp_get_attachment_image_src( $image, 'featured-module' );
	...
	$out .= '<a href="'.$url.'" class="featured-module featured-module-1 '.$no_scale.'">'.$badge_text.'<img class="img-responsive" src="'.$image_cropped[0].'">'.$featured_module_1_content.'</a>';
...
function vc_featured_module_2_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   $image_cropped = wp_get_attachment_image_src( $image, 'featured-module' );
	...
	$out .= '<a href="'.$url.'" class="featured-module featured-module-2 '.$no_scale.'">'.$badge_text.'<img class="img-responsive" src="'.$image_cropped[0].'">'.$featured_module_2_content.''.$featured_module_2_content_2.'</a>';
...
function vc_featured_module_3_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   $image_cropped = wp_get_attachment_image_src( $image, 'featured-module' );
	...
	$out .= '<a href="'.$url.'" class="featured-module featured-module-3 '.$no_scale.'">'.$badge_text.'<img class="img-responsive" src="'.$image_cropped[0].'">'.$featured_module_3_content.'</a>';
