...
function add_custom_scripts() {
	global $custom_meta_fields, $post, $pagenow;
...
if( getCurrentTemplate == "template-front.php"){
    $("#custom_meta_box-hide").attr("checked", true);
    $("#custom_meta_box").css({"display":"block"});
}else{
    $("#custom_meta_box-hide").attr("checked", false);
    $("#custom_meta_box").css({"display":"none"});
}
