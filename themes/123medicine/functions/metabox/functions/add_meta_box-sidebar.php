...
if ( getCurrentTemplate == "template-front.php"||getCurrentTemplate == "template-grid-blog.php"||getCurrentTemplate == "template-grid-portfolio.php"||getCurrentTemplate == "template-full-width.php"){
