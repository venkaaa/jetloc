...
jQuery(document).ready(function($) {
	...
	$('#upload_responsive_logo_button').click(function() {
	    formfield = $('#responsive_logo_img').attr('id');
	    tb_show('', 'media-upload.php?type=image&amp;TB_iframe=true');
	    return false;
	});
...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
            $('#c3_slide_upload_button_'+rowID).click(function() {
                formfield = $('#c3_slide_img_url_'+rowID).attr('id');
                tb_show('', 'media-upload.php?type=image&amp;TB_iframe=true');
                return false;
            });
	}
	function addUploader2(tableOrRow, rowID) {
            $('#c3_slide_upload_button2_'+rowID).click(function() {
                formfield = $('#c3_slide_img2_url_'+rowID).attr('id');
                tb_show('', 'media-upload.php?type=image&amp;TB_iframe=true');
                return false;
            });
	}
